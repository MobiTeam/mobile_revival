...
<html>
	...
	<head>
		...
		<title>Мобильный образовательный портал студента Югорского Государственного Университета</title>
		...
		<div id="helper_box">
			...
			на студентов очной и заочной формы обучения при их зачислении. Для того, чтобы узнать свой логин и пароль
			необходимо обратиться в учебную часть своего института. В случае утраты пароля его можно изменить,
			для этого обращайтесь в <b>«Учебно-производственный центр информационных технологий»</b> (4 корпус, 111 кабинет)<br>
			<br>Мобильный образовательный портал также работает и в <b>гостевом режиме</b>, который ограничен по функционалу.
			</div>
		...
		<div class="menuoverlay" style='display:none;' onclick="slideout.close()"></div>
			...
			<div class="content_box">
				...
				<div class="portfolio_view_box">
					Подождите, идет загрузка...
				</div>

				<div class="portfolio_loadfiles_box">
					<form class="portfolio-form contr_shadow" method="POST">
						<h3 style="font-weight: bold; font-size: 20px;">Форма загрузки нового документа</h3>
						<div class="portfolio-form-group">
							<span>Выберите категорию:</span><br>
							<select class="p_type_activity" name="p_type_activity" data-load="false">
							</select>
						</div>
						<div class="portfolio-form-group">
							<span>Выберите тип загружаемого документа:</span><br>
							<select class="p_document_type" name="p_document_type" data-load="false">
							</select>
						</div>
						<div class="portfolio-form-group">
							<span>Название файла:</span><br>
							<input type="text" class="p_document_fname" name="p_document_fname" placeholder="грамота за..." required>
						</div>
						<div class="portfolio-form-group">
							<span>Год достижения:</span><br>
							<input type="number" min="0" class="p_document_year" name="p_document_year" placeholder="2017" required>
						</div>
						<div class="portfolio-form-group">
							<input type="file" name="p_document_file" required>
						</div>
						<div class="portfolio-form-group">
				...
				<div class="portfolio_box">
					<div class="portfolio_box_menu_item portfolio_box_menu_showitem unselected" hashtag='portfolio_view'>
						Просмотр портфолио<br>
						<span class='fin_info_box_menu_item_stat rate_stat'>перейти</span>
					</div>
					<div class="portfolio_box_menu_item portfolio_box_menu_workitem unselected" hashtag='portfolio_loadfiles'>
						Работа с документами<br>
						<span class='fin_info_box_menu_item_stat income_stat'>перейти</span>
					</div>
				</div>
				...
				<div class="abit_info_box">
					...
					<div class="abit_results">
						...
						<!-- <div class="abit_details_results person_contacts_info contr_shadow">
						123
						</div> -->
					</div>
				...
				<div class="authorisation_box">
					...
					<div class="authorisation_box_logo">
					 ...
					 <form class="authorisation_box_form" method="post" action="">
						...
						<div class="auth_buttons">
					    	<input class="authorisation_box_button half_size_button contr_shadow" type="button" value="Пропустить" >
							<input class="authorisation_box_submit half_size_button contr_shadow" type="submit" value="Войти" >
					    	<div style="clear:both"></div>
					    </div>
					</form>
					   <!--  <button class="authorisation_box_abit contr_shadow">
					    	<i class="abit_btn_icon"></i>
					    	<span>Я абитуриент</span>
					    </button> -->
				  ...
				  <div class="main_menu">
				    ...
				    <div class="content_box_itemwrapper unselected" unselectable="on" onselectstart="return false;">
						...
						<!-- <div class="content_box_menuitem contr_shadow authblock only_stud" hashtag="message">
						...
						<div class="content_box_menuitem contr_shadow authblock only_stud" hashtag="portfolio">

							<!-- <img src="img/message_new.png" /> -->
						    <div class="main_portfolio_icon main_icon_block"></div>
